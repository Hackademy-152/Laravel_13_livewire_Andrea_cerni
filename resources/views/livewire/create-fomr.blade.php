...
<!--sciacalliamo da bs il form e lo modifichiamo coi campi a noi necessari!-->
    <form wire:submit="createArticle"><!--questa sintassi ci consente di collegare il form alla funzione che crea gli articoli e la fa scattare! in pratica copio la function dentro il form! -->
        <div class="mb-3">
          <label class="form-label text-bg-info">inserisci il titolo{{$titolo}}</label>
        ...
        <div class="mb-3">
          <label class="form-label text-bg-danger">inserisci il genere{{$genere}}</label>
        ...
        <button type="submit" class="btn btn-primary m-1">inserisci il tuo testo!</button>
      </form>
